...
def demo():
    if request.method == 'POST':
        ...
        if not image_file:
            ...
            # my_file = "C:/Users/Alston Soares/Desktop/Demo-Codlions/website/static/profile_pics/Alston.png"
            # path2 = "C:/Users/Alston Soares/Desktop/Demo-Codlions/website/static/uploads/"
            ...
            for i in User.query.all():
                ...
                if i.id != 1:
                    global glob_name
                    users = f"C:/Users/Alston Soares/Desktop/Demo-Codlions/website/static/profile_pics/{i.username}.{i.filetype}"
                    ...
                    # unknown_file = f"C:/Users/Alston Soares/Desktop/Demo-Codlions/website/static/uploads/{filename}"
                    ...
                    if results[0] == True:
                        flash(f"It's a picture of {i.username}!", category="success")
                        glob_name = i.username
                        path3 = "C:/Users/Alston Soares/Desktop/Demo-Codlions/website/static/uploads/"
                        ...
                        fullpath3 = os.path.join(path3, result)
...
def upload():
    if request.method == 'POST':
        ...
        if not my_file:
            ...
            path2 = f"C:/Users/Alston Soares/Desktop/Demo-Codlions/website/static/storage/{current_user.username}/"
...
def delete_store(id):
    ...
    if sto.user_id == current_user.id:
        my_path = f"C:/Users/Alston Soares/Desktop/Demo-Codlions/website/static/storage/{current_user.username}/{sto.my_file}"
